...
workdir <- "/Users/chris/Desktop/20240308_mmus_prostate_EAW"
...
# bash_file <- file.path(workdir, "scripts/rnaseq_mus_prostate_EAW_pipeline/01a_download_fastq_locally/download_fastq_locally.sh")
